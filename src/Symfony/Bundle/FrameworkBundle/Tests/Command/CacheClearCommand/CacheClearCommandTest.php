...
class CacheClearCommandTest extends TestCase
{
    ...
    public function testCacheIsFreshAfterCacheClearedWithWarmup()
    {
        ...
        $this->assertMatchesRegularExpression(sprintf('/\'kernel.container_class\'\s*=>\s*\'%s\'/', \get_class($this->kernel->getContainer())), file_get_contents($containerFile), 'kernel.container_class is properly set on the dumped container');
    }
}
