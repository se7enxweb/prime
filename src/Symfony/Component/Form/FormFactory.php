...
class FormFactory implements FormFactoryInterface
{
    ...
    public function createNamedBuilder($name, $type = 'Symfony\Component\Form\Extension\Core\Type\FormType', $data = null, array $options = array())
    {
        ...
        if ($type instanceof FormTypeInterface) {
            ...
            @trigger_error(sprintf('Passing type instances to FormBuilder::add(), Form::add() or the FormFactory is deprecated since Symfony 2.8 and will not be supported in 3.0. Use the fully-qualified type class name instead (%s).', ($t = $type->getInnerType()) !== null ? \get_class($t) : 'unknown'), E_USER_DEPRECATED);
        } else {
            throw new UnexpectedTypeException($type, 'string, Symfony\Component\Form\ResolvedFormTypeInterface or Symfony\Component\Form\FormTypeInterface');
        }
