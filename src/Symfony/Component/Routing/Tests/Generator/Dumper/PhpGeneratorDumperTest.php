...
class PhpGeneratorDumperTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->testTmpFilepath = sys_get_temp_dir().\DIRECTORY_SEPARATOR.'php_generator.'.$this->name().'.php';
        $this->largeTestTmpFilepath = sys_get_temp_dir().\DIRECTORY_SEPARATOR.'php_generator.'.$this->name().'.large.php';
