...
class DefaultAuthenticationFailureHandlerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->exception = $this->getMockBuilder('Symfony\Component\Security\Core\Exception\AuthenticationException')->onlyMethods(array('getMessage'))->getMock();
    }
    ...
    public function testFailurePathCanBeOverwrittenWithNestedAttributeInRequest()
    {
        $this->request->expects($this->once())
            ->method('get')->with('_failure_path')
            ->willReturn(array('value' => '/auth/login'));
