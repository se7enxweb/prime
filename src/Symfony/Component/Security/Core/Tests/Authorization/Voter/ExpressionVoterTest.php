...
class ExpressionVoterTest extends TestCase
{
    ...
    #[DataProvider('getVoteTests')]    public function testVote($roles, $attributes, $expected, $tokenExpectsGetRoles = true, $expressionLanguageExpectsEvaluate = true)
    {
    ...
    public static function getVoteTests()
    {
        return array(
            ...
            array(array(), array(self::createExpression()), VoterInterface::ACCESS_DENIED, true, false),

            array(array('ROLE_FOO'), array(self::createExpression(), self::createExpression()), VoterInterface::ACCESS_GRANTED),
            array(array('ROLE_BAR', 'ROLE_FOO'), array(self::createExpression()), VoterInterface::ACCESS_GRANTED),
        );
    }
