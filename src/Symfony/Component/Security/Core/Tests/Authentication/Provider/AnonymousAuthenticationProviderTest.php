...
class AnonymousAuthenticationProviderTest extends TestCase
{
    ...
    {
        $token = $this->getMockBuilder('Symfony\Component\Security\Core\Authentication\Token\AnonymousToken')->onlyMethods(array('getSecret'))->disableOriginalConstructor()->getMock();
